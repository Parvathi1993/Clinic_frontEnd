...
const ProcedureCatgryDropDown = ({ procedure_catgry_slno, setprocedure_catgry_slno }) => {
    const [specialityprodurArry, setProdrArry] = useState([])
    useEffect(() => {
        const getProcedure = async () => {
            const result = await axioslogin.get('/ProcedurCatMaster/getProcedureCatgryList');
...
export default memo(ProcedureCatgryDropDown)